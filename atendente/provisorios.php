<?php require_once("../admin/topo.php"); ?>
	<div class="container">
		...
		<form action="addAtendimento.php" method="POST">
		...
		<div class="col-lg-3">
			<form action="gerarRelatorioProvisorios.php" method="POST">
		...
		<div class="titulo">
			<h2 class="text-uppercase"><strong>Atendimentos Provisórios</strong></h2>
		</div>
